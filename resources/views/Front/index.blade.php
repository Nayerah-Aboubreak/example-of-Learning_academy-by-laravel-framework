...
@section('content')
    ...
    <!-- banner part start-->
    <section class="banner_part my-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-xl-3 align-self-center">
                    <div class="single_feature_text ">
                        <h2>{{json_decode($feature_content->content)->maintitle}}</h2>
                        <p>{{json_decode($feature_content->content)->maindesc}} </p>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <h4>{{json_decode($feature_content->content)->title1}}</h4>
                            <p>{{json_decode($feature_content->content)->desc1}}</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <h4>{{json_decode($feature_content->content)->title2}}</h4>
                            <p>{{json_decode($feature_content->content)->desc2}}</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part single_feature_part_2">
                            ...
                            <h4>{{json_decode($feature_content->content)->title3}}</h4>
                            <p>{{json_decode($feature_content->content)->desc3}}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="member_counter padding_top mt-5">
        <div class="container ">
            <div class="row">
    ...
    <!--::review_part start::-->
    <section class="testimonial_part padding_top mb-5">
